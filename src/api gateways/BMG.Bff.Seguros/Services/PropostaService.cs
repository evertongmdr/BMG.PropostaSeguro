...
namespace BMG.Bff.Seguros.Services
{
    ...
    public interface IPropostaService
    {
        ...
        public Task<ApiResponse> AtualizarStatusPropostaAsync(Guid propostaId, AtualizarStatusPropostaDTO atualizarStatusPropostaDTO);
    ...
    public class PropostaService : Service, IPropostaService
    {
        ...
        public async Task<ApiResponse> AtualizarStatusPropostaAsync(Guid propostaId, AtualizarStatusPropostaDTO atualizarStatusPropostaDTO)
        {
            var atualizarStatusPropostaContent = ObterConteudo(atualizarStatusPropostaDTO);

            var response = await _httpClient.PutAsync($"/proposta/atualizar-status/{propostaId}", atualizarStatusPropostaContent);
